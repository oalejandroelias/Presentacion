...
const InfoRegiones = (props) => {
    return (
        <div class="w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg dark:bg-gray-800 font-per-theme-default">
            ...
            <h2 class="mt-2 text-xl font-semibold md:mt-0">{props.region.title}</h2>
