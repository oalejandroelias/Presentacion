    ...
    return (
        <div className="container mx-auto py-16">
            ...
            <div className=" mx-auto align-middle grid grid-cols-1 gap-8 md:grid-cols-3">
                ...
                <div className="col-span-2 sm:text-left text-center container px-6 mx-auto align-middle content-center">
                    <h2 className="text-gray-900 text-xl title-font font-medium mb-2">Como utilizar nuestros servicios?</h2>
